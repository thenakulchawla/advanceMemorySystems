...
\begin{abstract}
    ...
    being the foundation of cryptocurrencies like Dash, the blockchain
    ...
    authority. The distributed ledger makes it a compulsion to store the complete
    blockchain on each node in order for them to individually validate a
    transaction. This 
